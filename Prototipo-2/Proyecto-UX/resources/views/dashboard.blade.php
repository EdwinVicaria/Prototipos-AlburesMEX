...
<style>
    ...
    */
    .fondo{
            background-image: url(https://www.xtrafondos.com/wallpapers/resized/rascacielos-6261.jpg?s=large);
    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <div class="col-span-2">
                ...
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div class="hidden w-full md:block md:w-auto pl-20 pr-10" id="mobile-menu">
                        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                            ...
                            <li>
                            <a href="{{route('propios')}}" class="block text-white border-b border-gray-100 hover:bg-gray-50 md:hover:bg-red md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-red-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">MIS ALBURES</a>
                            </li>
                            @if (Route::has('login'))
                                <div class=" pl-18">
                                    @auth
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <h3 class="p-10 text-2xl text-white">Saludos, <b>TÚ</b> que no eres de México queremos que comprendas las expresiones que aveces
                ...
                <div>
                    <h3 class="p-10 text-2xl mt-36 text-white">Si eres mexicano pues, ojalá que te encuentres alguna sorpresita por ahí, algo que no conocias, 
                        y conste que no estoy albureando.
                    </h3>
                </div>
            </div>
            <div class="flex">
                <img class="rounded-lg w-40 mt-5 ml-10"  src="https://c.tenor.com/N3m4R2cmu4MAAAAC/animo-positivo.gif" alt="imagen gif">
