...
<body class="fondo">
    ...
    <div class="container ">
        ...
        <div class="grid grid-cols-3 gap-4 pl-72 pr-72 py-16 ">
            @foreach ($alburs as $alburs)
            <div class="col-span-3 border border-black rounded-lg p-2 text-white bg-sky-900 bg-opacity-50">
                <div class="grid grid-cols-3 gap-4 ">
                    ...
                    <p class="opacity-100 texto text-2xl font-black text-white">{{$alburs->tipo->tipo}}</p>
