...
var chart = new Chart(ctx2, {
    ...
    <div class="flex">
                <div class="card bg-green-600 shadow-lg w-60 -mt-24 rounded-3xl   transform -rotate-12 origin-top-left">
                    <div>
                        <h1><img src="img/darkar.png" alt=""></h1>
                    </div>
                </div>
                <div class="card bg-white shadow-lg w-60 -mt-14 rounded-3xl   transform rotate-45 origin-bottom ">
                    <div>
                        <h1><img src="img/mecoboy.png" alt=""></h1>
                    </div>
                </div>
                <div class="card bg-red-600 shadow-lg w-60 mb-24 rounded-3xl   transform -rotate-45">
                    <div>
                        <h1><img src="img/darkar2.png" alt=""></h1>
                    </div>
                </div>
    </div>
