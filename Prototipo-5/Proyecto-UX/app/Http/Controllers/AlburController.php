...
*/
    ...
    public function destroy($id)
    {
        ...
        $alburs->delete();
        return redirect()->route('albures')->with('mensaje','¡¡¡¡Albur eliminado con exito!!!!');
    }


    // FUNCION QUE MUESTRA LOS TIPOS DE ALBUR
    public function tipo(){
        $tipo=Tipo::all();
        return view('tipo',['tipo'=>$tipo]);
    }

    public function TipoAlbur($id){
        $albures=Albur::where('tipo_id',$id)->get();
        return view('alburs.tiposDeAlbur',['albures'=>$albures]);
    }
