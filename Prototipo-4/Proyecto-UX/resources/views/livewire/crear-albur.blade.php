<div>
    ...
    <button class="border-black border-2 bg-white bg-opacity-50 p-3 rounded-full" wire:click="abrirModal()">IMPRESIONANOS!!</button>
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <div class="absolute -left-96  max-w-md">
                <form wire:submit.prevent="submit" class=" p-4 text-white rounded-lg bg-yellow-400 ">
                    ...
                    <div class="mb-10">
                        <label class="text-black font">Albur:</label>
                    ...
                    <div class="mb-10">
                        <label class="text-black font">Describe de que trata tu nuevo albur:</label>
                    ...
                    <div class="mb-10">
                        <label class="text-black rounded-lg font">Elija el tipo de albur que esta compartiendo:</label>
                    ...
                    <div>
                        <button wire:click="cerrarModal1()" class="border p-2 bg-red-500 rounded-lg text-black w-32 h-10">
                            Cancelar
                        </button>
